...
* Tested and confirmed the REST API to add the pagination feature on the existing API `/uploads/{id}/licenses`
* Added the new REST API to get the contents of a specific file given the **upload's id** and the **item's id**.
